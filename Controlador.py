...
#%%    # Camara y Marcador
    ...
    def cargar_imagen(self, ruta_imagen, escala_grises=False):
        return self.__mi_modelo.cargar_imagen(ruta_imagen, escala_grises)

    def recuperar_imagen_cargada(self):
        return self.__mi_modelo.recuperar_imagen_cargada()
    
    def resetear_frame_procesado(self):
        return self.__mi_modelo.resetear_frame_procesado()
...
#%%     # OCR
    ...
    def identificar_texto(self):
        return self.__mi_modelo.identificar_texto()
